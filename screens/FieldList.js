        ...
        [
            {
                ...
                onPress: () => navigation.navigate("ReviewScreen", { field }), // Thực hiện hành động xem chi tiết
            },
            {
                text: 'Đặt sân',
                onPress: () => navigation.navigate("FieldBooking", { field }), // Thực hiện hành động đặt sân
            },
            {
                text: 'Hủy',
                style: 'cancel',
