...
const RegisterScreen = () => {
  ...
  const [showClearPhoneNumberIcon, setShowClearPhoneNumberIcon] =
    useState(false);
  ...
  const [showPasswordVisibilityIcon, setShowPasswordVisibilityIcon] =
    useState(false);
  const [
    showConfirmPasswordVisibilityIcon,
    setShowConfirmPasswordVisibilityIcon,
  ] = useState(false);
  const [hideVisibilityPassword, setHidePasswordVisibility] = useState(true);
  const [hideVisibilityConfirmPassword, setHideConfirmPasswordVisibility] =
    useState(true);
